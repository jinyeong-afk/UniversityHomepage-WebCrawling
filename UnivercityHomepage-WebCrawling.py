...
add = 'https://door.deu.ac.kr/MyPage' # 홈페이지 주소
...
driver.find_element_by_css_selector('body > form > div:nth-child(5) > div:nth-child(5) > div > table > tbody > tr:nth-child(1) > td:nth-child(2) > input').send_keys() #아이디
driver.find_element_by_css_selector('body > form > div:nth-child(5) > div:nth-child(5) > div > table > tbody > tr:nth-child(2) > td > input').send_keys() #비번
